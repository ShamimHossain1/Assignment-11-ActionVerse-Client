...
const Blog = () => {
    ...
    return (
        <div>
            <div className='mb-10'>
                <div className='bg-gray-100 shadow-md text-center mb-5'>
                    <h1 className='font-bold text-2xl py-32 text-blue-600'>Blog</h1>
                </div>
                <div className='px-10'>
                    <div className='border text-center bg-gray-100 shadow-md p-5'>
                        <h1 className='mb-2 font-semibold text-blue-600'>What is an access token and refresh token? How do they work and where should we store them on the client-side?</h1>
                ...
                <div className='px-10 mt-5'>
                    <div className='border text-center bg-gray-100 shadow-md p-5'>
                        <h1 className='mb-2 font-semibold text-blue-600'>Compare SQL and NoSQL databases?</h1>
                ...
                <div className='px-10 mt-5'>
                    <div className='border text-center bg-gray-100 shadow-md p-5'>
                        <h1 className='mb-2 font-semibold text-blue-600'>What is express js? What is Nest JS?</h1>
                ...
                <div className='px-10 mt-5'>
                    <div className='border text-center bg-gray-100 shadow-md p-5'>
                        <h1 className='mb-2 font-semibold text-blue-600'>What is MongoDB aggregate and how does it work?</h1>
