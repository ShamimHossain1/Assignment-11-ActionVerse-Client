                ...
                <div className="px-5 pb-5">
                    ...
                    <div className="flex items-center justify-between">
                        ...
                        <Link
                            to={`/toys/${_id}`}
                        >
                            <button href="#" className="text-white bg-blue-600 hover:scale-110 duration-300 focus:ring-4 focus:outline-none font-medium rounded-lg text-sm px-5 py-2.5 text-center">View Details</button>
                        </Link>
                    </div>
                </div>
            </div>
